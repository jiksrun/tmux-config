...
tmux_set @prefix_highlight_output_prefix "#[fg=$TC]#[bg=$G0]#[bg=$TC]#[fg=$G0]"
tmux_set @prefix_highlight_output_suffix "#[fg=$TC]#[bg=$G0]"
...
RS=""
if "$show_time"; then
    RS+="#[fg=$G2]$larrow#[fg=$TC,bg=$G2] $time_icon $time_format "
fi
if "$show_date"; then
    # RS+="#[fg=$TC,bg=$G2]$larrow#[fg=$G0,bg=$TC] $date_icon $date_format "
    RS+="#[fg=$TC]$larrow#[fg=$G0,bg=$TC] $date_icon $date_format "
fi
